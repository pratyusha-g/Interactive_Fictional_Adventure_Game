...
game_title = "Castle Dungeons - an interactive story game"
...
cls() #terminal screen will be cleared
...
def Intro():
    ...
    An evil sorcerer is holding your fellow adventurers as prisoners.
    Will you succeed in freeing your friends from the castle dungeons, or perish trying?
    """)
...
def create_character_skill_sheet():
    cls()
    global character_name, character_class, character_race, character_strength, character_dexterity, character_life, character_magic
    print("""
    ...
    - Life, which determines your life energy. Points will be lost when hurt, and whenever your life reaches 0, your character dies
...
def modify_skills():
    cls()
    global character_class, character_race, character_strength, character_dexterity, character_life, character_magic
    print("To modify your skills, roll a six-faced die for each of your skills, and the game will add the number to your skill")
...
def skill_check():
    cls()
    print("""
    A giant rock falls from the ceiling, roll a die to see if you can dodge it...or you will be crushed by it!
    """)
    roll = randint(1,6)
    print("You rolled " + str(roll))
    if roll + character_dexterity > 10:
        ...
        The strange noise in the darkness continues, and sounds a lot closer now...
        """)
        input("Press Enter to continue...")
        combat()
    else:
        print("""
        You have been crushed by the rock. You die. The game is over.
        """)
        input("Press Enter to exit the game.")
